...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner MoveEngine
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &kubemovev1alpha1.MoveEngine{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileMoveEngine) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set MoveEngine instance as the owner and controller
...
func newPodForCR(cr *kubemovev1alpha1.MoveEngine) *corev1.Pod {
